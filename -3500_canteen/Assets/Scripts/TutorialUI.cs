...
public class TutorialUI : MonoBehaviour
{
    ...
    [SerializeField]
    private TextMeshProUGUI keyAlternateInteractText;
    ...
    private void Start()
    {
        ...
        KitchenGameManager.Instance.OnStateChangedLocal += KitchenGameManager_OnStateChanged;
        UpdateVisual();
    ...
    private void UpdateVisual()
    {
        ...
        keyAlternateInteractText.text = GameInput.Instance.GetBindingText(
