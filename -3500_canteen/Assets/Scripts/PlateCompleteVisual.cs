...
public class PlateCompleteVisual : MonoBehaviour
{
    ...
    [SerializeField]
    private List<KitchenObjectOS_GameObject> kitchenObjectOSGameObjectList;
    ...
    private void Start()
    {
        ...
        foreach (
            KitchenObjectOS_GameObject kitchenObjectOSGameObject in kitchenObjectOSGameObjectList
        )
        {
